...
\endhead
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1020}{QSERV-PRF-20-10: \gls{Object} Source Join Shared Scan Scaling} \tabularnewline
...
\subsubsection{Test Items}
This test will show that average completion-time of full-scan queries of
the \gls{Source} catalog table grow sub-linearly with respect to the number of
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1020}{LVV-T1020}
    - QSERV-PRF-20-10: \gls{Object} Source Join Shared Scan Scaling}\label{lvv-t1020}
...
which join the \gls{Object} and \gls{Source} catalog tables grow sub-linearly with
...
\subsubsection{Test Items}
This test will show that average completion-time of full-scan queries
which join the \gls{Object} and \gls{ForcedSource} catalog tables grow sub-linearly
