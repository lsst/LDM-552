...
schedule described in LVV-T1022 (QSERV-PRF-10-00). ~Tools for synthesis
of ingest of test datasets may be found in the LSST github repot at
https://github.com/lsst-dm/db\_tests\_kpm20. ~Detailed use and context
...
and record execution time.
            ...
            & Expected Result &
                \begin{minipage}[t]{13cm}{\footnotesize
                Query runs in less than 5 seconds.
