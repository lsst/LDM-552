...
\endhead
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1013}{QSERV-VER-00-00: \gls{Qserv} design inspection} \tabularnewline
    \hyperref[lvv-t1014]{LVV-T1014} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1014}{QSERV-VER-00-10: \gls{Qserv} test inspection} \tabularnewline
    \hyperref[lvv-t1015]{LVV-T1015} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1015}{QSERV-VER-00-05: \gls{Qserv} code inspection} \tabularnewline
    \hyperref[lvv-t1016]{LVV-T1016} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1016}{QSERV-PRF-20-00: \gls{Object} Shared Scan Scaling} \tabularnewline
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1019}{QSERV-PRF-20-05: \gls{Source} Shared Scan Scaling} \tabularnewline
    \hyperref[lvv-t1020]{LVV-T1020} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1020}{QSERV-PRF-20-10: \gls{Object} \gls{Source} Join Shared Scan Scaling} \tabularnewline
    \hyperref[lvv-t1021]{LVV-T1021} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1021}{QSERV-PRF-20-15: \gls{Object} ForcedSource Join Shared Scan Scaling} \tabularnewline
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1013}{LVV-T1013}
    - QSERV-VER-00-00: \gls{Qserv} design inspection}\label{lvv-t1013}

\begin{longtable}[]{llllll}
\toprule
Version & Status & Priority & \gls{Verification} Type & Owner
\\\midrule
1 & Approved & Normal &
...
This test will check that the design of QSERV is adequate to meet the \gls{DM}
...
\subsubsection{Test Procedure}
    ...
    \endhead
            ...
            By reference to {LDM-135}, the \gls{Qserv} design document, and LDM-555, the
Qserv requirements\\
document, demonstrate that elements exist in the design as stated to
address each of individual requirements
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1014}{LVV-T1014}
    - QSERV-VER-00-10: \gls{Qserv} test inspection}\label{lvv-t1014}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1015}{LVV-T1015}
    - QSERV-VER-00-05: \gls{Qserv} code inspection}\label{lvv-t1015}
...
\tightlist
\item
  That the code delivered complies with relevant \gls{DM} software quality
  standards;
\item
  That the code is accompanied by appropriate documentation;
\item
  That the code makes use of appropriate \gls{DM} interfaces to the rest of
...
codebase
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 2 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Check the code to demonstrate that uses only standardized \gls{DM} interfaces
for such things as logging and \gls{configuration} (i.e. it does not print
directly to screen nor does it contain ad-hoc \gls{configuration} parsers)
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1016}{LVV-T1016}
    - QSERV-PRF-20-00: \gls{Object} Shared Scan Scaling}\label{lvv-t1016}
...
\item
  ...
  the \gls{LSST} QSERV github repository here:
...
\subsubsection{Test Procedure}
    ...
    \endhead
                ...
                Ensure that \gls{Qserv} instance under test is up to date and that there is no
...
\subsubsection{Test Items}
Before running any of the performance test cases, \gls{Qserv} must be
installed on an appropriate test cluster (e.g.\\
the test machine cluster at CC-IN2P3).~~To upgrade \gls{Qserv} software on the
cluster in preparation for testing,\\
follow directions
at~\textbf{\textbackslash{}url}\{http://www.slac.stanford.edu/exp/lsst/qserv/2015\_10/HOW-TO/cluster-deployment.html\}.\\
~\\
The performance tests will also require an appropriately sized test
dataset to be synthesized and ingested,\\
per the yearly dataset sizing schedule described
in~\textbf{\textbackslash{}hyperref}{[}qserv-prf-10{]}\{\textbf{\textbackslash{}textsc}\{QSERV-PRF-10\}\}.~~Tools\\
for synthesis of ingest of test datasets may be found in the \gls{LSST} github
repot
at~\textbf{\textbackslash{}url}\{https://github.com/lsst-dm/db\_tests\_kpm20\}.~~Detailed
use and context information for the tools is described
in~\textbf{\textbackslash{}url}\{https://jira.lsstcorp.org/browse/DM-8405\}.\\
~\\
It has also been found that the \gls{Qserv} shard servers must have
...
issue is avilable
at~\textbf{\textbackslash{}url}\{https://confluence.lsstcorp.org/pages/viewpage.action?pageId=58950786\}.
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1019}{LVV-T1019}
    - QSERV-PRF-20-05: \gls{Source} Shared Scan Scaling}\label{lvv-t1019}
...
\subsubsection{Test Items}
This test will show that average completion-time of full-scan queries of
the \gls{Source} catalog table grow\\
sub-linearly with respect to the number of simultaneously active
full-scan queries, within the limits of\\
machine resource exhaustion.
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1020}{LVV-T1020}
    - QSERV-PRF-20-10: \gls{Object} \gls{Source} Join Shared Scan Scaling}\label{lvv-t1020}
...
which join the \gls{Object} and Source\\
catalog tables grow sub-linearly with respect to the number of
simultaneously active full-scan queries, within\\
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1021}{LVV-T1021}
    - QSERV-PRF-20-15: \gls{Object} ForcedSource Join Shared Scan Scaling}\label{lvv-t1021}
...
\subsubsection{Test Items}
This test will show that average completion-time of full-scan queries
which join the \gls{Object} and ForcedSource\\
catalog tables grow sub-linearly with respect to the number of
simultaneously active full-scan queries, within\\
the limits of machine resource exhaustion.
...
\subsubsection{Test Procedure}
    ...
    \endhead
            ...
            \multirow{3}{*}{ 1 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Inspect and possibly modify the \textbackslash{}texttt\{CONCURRENCY\}
and \textbackslash{}texttt\{TARGET\textbackslash{}\_RATES\} dictionaries
in the runQueries.py script to adjust the concurrency mix and target
execution times per query class. ~Query mixes and target times are to be
adjusted per the following schedule:\\
~\\
